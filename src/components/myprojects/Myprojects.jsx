      ...
      <div className="container portfolio__container">
        ...
        <article className='portfolio__item'>
            ...
            <div className="portfolio__item-cta">
              ...
              <a href="https://vasanthakumar-portfolio.netlify.app/" target="_blank" rel='noreferrer' className='btn btn-primary'>Visit Website</a>  
            </div>
        ...
        <article className='portfolio__item'>
            ...
            <h3>User Registration Application</h3>
            <small className='text-light'> ReactJs | Node.js | Express.js | Mysql</small>
            <div className="portfolio__item-cta">
              <a href="https://github.com/vasanthvk1000/Vasanthakumar-Portfolio.git" target="_blank" rel='noreferrer' className='btn'>Github</a>
            </div>
